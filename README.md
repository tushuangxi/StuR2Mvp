...
public interface IMoiveListView extends IWanBaseView{
    ...
    void onLoadSucess(MoiveListResponse moiveListRsp);
...
public class MainActivity extends AWanBaseActivity<IMoiveListView,MoiveListPresenter>
    ...
    @Override
    public void onLoadSucess(MoiveListResponse     moiveListRsp) {
        MoiveListResponse.TrailersBean trailersBean = moiveListRsp.getTrailers().get(1);
    ...
    public void getMoiveList(){
        ...
        wApi.getMoiveList()
                ...
                .subscribe(new ApiSubscriber<MoiveListResponse>() {
                    @Override
                    public void onNext(MoiveListResponse moiveListRsp) {
